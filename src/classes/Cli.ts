    ...
    inquirer
      .prompt([
        {
          ...
          choices: this.vehicles.map((vehicle) => {
            return {
              name: `${vehicle.vin} -- ${vehicle.make} ${vehicle.model}`,
              value: vehicle.vin, // Change to vehicle.vin to ensure a unique identifier
            };
          }),
        },
      ])
      .then((answers: any) => {
        ...
        if (selectedVehicle === truck) {
          ...
          this.findVehicleToTow(truck); // Allow user to select again
        } else {
          ...
          for (let i = 0; i < this.vehicles.length; i++) {
            if (this.vehicles[i].vin === this.selectedVehicleVin) {
              if (this.vehicles[i] instanceof Truck) {
                ...
                console.log(`Selected vehicle ${this.vehicles[i].make} ${this.vehicles[i].model} cannot tow`);
              }
            }
          }
        }
          ...
          for (let i = 0; i < this.vehicles.length; i++) {
            if (this.vehicles[i].vin === this.selectedVehicleVin) {
              if (this.vehicles[i] instanceof Motorbike) {
                ...
                console.log(`Selected vehicle ${this.vehicles[i].make} ${this.vehicles[i].model} can not do a wheelie`)
              }
            }
          }
        }
